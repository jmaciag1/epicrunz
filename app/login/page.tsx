...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1551698618-1dfe5d97d256?auto=format&fit=crop&w=1920&q=80)',
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-gray-900/80 backdrop-blur-md border border-white/10 p-8 rounded-2xl shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mt-4">Welcome back, runner</h1>
